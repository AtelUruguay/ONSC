...
class ONSCLegajoAltaCS(models.Model):
    ...
    def _compute_should_disable_form_edit(self):
        ...
        for record in self:
            ...
            is_editable_dest__ue =  record.operating_unit_destination_id == operating_unit_id and is_user_ue
            ...
            elif record.state == 'to_process' and record.type_cs == 'ac2ac' and not (is_editable_dest_inciso or is_editable_dest__ue):
                record.should_disable_form_edit = True
