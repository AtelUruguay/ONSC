    ...
    def _check_date(self):
        for record in self:
            if record.start_date > record.end_date:
                raise ValidationError(_("La fecha inicio debe ser menor o igual a la fecha de fin"))
            if record.start_date_max > record.end_date_max:
                raise ValidationError(_("La fecha inicio máxima debe ser menor o igual a la fecha de fin máxima"))
            if record.end_date > record.end_date_max:
                raise ValidationError(_("La fecha fin debe ser menor o igual a la fecha de fin máxima"))
